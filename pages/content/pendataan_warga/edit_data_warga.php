...
<head>
  ...
  <title>Edit Data Warga Desa</title>
  <style>
    .mx-auto {
      width: 800px
    }
  ...
  <div class="mx-auto">
    <div class="card">
      ...
      <div class="card-body">
        ...
        ?>
        <form action="./../../../backend/pendataan_warga/edit_data_warga.php?idwarga=<?php echo $id; ?>" method="POST">
          
          <div class="mb-3 row">
            <label for="nik" class="col-sm-4 col-form-label">NIK</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id="nik" name="nik" value="<?php echo $data['NIK_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="nama" class="col-sm-4 col-form-label">Nama Lengkap</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $data['nama_lengkap_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="tempatlahir" class="col-sm-4 col-form-label">Tempat Lahir</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id="tempatlahir" name="tempatlahir" value="<?php echo $data['tempat_lahir_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="tanggallahir" class="col-sm-4 col-form-label">Tanggal Lahir</label>
            <div class="col-sm-12">
              <input type="date" class="form-control" id="tanggallahir" name="tanggallahir" value="<?php echo $data['tanggal_lahir_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" id=alamat" name="alamat" value="<?php echo $data['alamat_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="provinsi" class="col-sm-4 col-form-label">Provinsi</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id=provinsi" name="provinsi" value="<?php echo $data['provinsi_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="kabupaten" class="col-sm-4 col-form-label">Kabupaten/Kota</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id=kabupaten" name="kabupaten" value="<?php echo $data['kabupaten_kota_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="kecamatan" class="col-sm-4 col-form-label">kecamatan</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id=kecamatan" name="kecamatan" value="<?php echo $data['kecamatan_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" id=kewarganegaraan" name="kewarganegaraan" value="<?php echo $data['kewarganegaraan_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="agama" class="col-sm-4 col-form-label">Agama</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id=agama" name="agama" value="<?php echo $data['agama_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="pendidikan" class="col-sm-4 col-form-label">Pendidikan</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id=pendidikan" name="pendidikan" value="<?php echo $data['pendidikan_terakhir_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="pekerjaan" class="col-sm-4 col-form-label">Pekerjaan</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id=pekerjaan" name="pekerjaan" value="<?php echo $data['pekerjaan_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="statusperkawinan" class="col-sm-4 col-form-label">Status Perkawinan</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id=statusperkawinan" name="statusperkawinan" value="<?php echo $data['status_perkawinan_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" id=namaayah" name="namaayah" value="<?php echo $data['nama_ayah_tdw'];?>">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="namaibu" class="col-sm-4 col-form-label">Nama Ibu</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id=namaibu" name="namaibu" value="<?php echo $data['nama_ibu_tdw'];?>">
            </div>
          </div>
